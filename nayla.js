...
break
case 'menu':
menuu = `Marhaban ya Ramadhan, bulan suci penuh berkah telah tiba. Saatnya untuk lebih mendekatkan diri pada-Nya, menjauhi keburukan, memperbanyak ibadah. Dengan segala kerendahan hati, mohon maaf lahir dan batin. Marhaban ya Ramadhan. Selamat menunaikan ibadah puasa.`
await sendMenuu(from, menuu, "Lightweight full-featured WhatsApp Web + Multi-Device API", await nayla.sendnew(from, {video: {url: "./media/video/menuu.mp4", caption: menuu}, gifPlayback: true}))
break
case 'desk':
replyy(`⋗⋗⋗⋗⋗⋗⋗⋗⋗⋗⋗⋗⋗⋗⋗⋗⋗⋗⋗⋗
✄ *PERATURAN*
